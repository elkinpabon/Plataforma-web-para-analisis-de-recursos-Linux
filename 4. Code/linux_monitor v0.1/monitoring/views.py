...
def system_usage(request):
    """Obtiene datos en tiempo real del sistema y los devuelve en formato JSON."""
    ...
    net_upload_kbps = round((current_net_stats.bytes_sent - prev_net_stats.bytes_sent) / 1024, 2)
    net_download_kbps = round((current_net_stats.bytes_recv - prev_net_stats.bytes_recv) / 1024, 2)
